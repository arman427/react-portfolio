      ...
      <div className="about-benefits">
         <div className="about-benefits__list grid gap-10">
            <div className="about-benefits__card__wrapper flex justify-start items-start gap-5 bg-white/[5%] p-5 rounded-4xl dark:bg-black/10">
               <svg className="bi bi-code about-icon bg-white/10 px-3 py-3 rounded-[100%] fill-black" xmlns="http://www.w3.org/2000/svg" width="50" height="45" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div className="about-benefits__card__wrapper flex justify-start items-start gap-5 bg-white/[5%] p-5 rounded-4xl dark:bg-black/10">
               <svg xmlns="http://www.w3.org/2000/svg" width="50" height="45" fill="currentColor" className="bi bi-code about-icon bg-white/10 px-3 py-3 rounded-[100%] fill-black" viewBox="0 0 16 16">
